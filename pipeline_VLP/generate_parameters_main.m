function parameters = generate_parameters_main(movie_per_frame, parameters, varargin)
...
parameters = get_all_non_input_parameters(movie_per_frame, parameters);
    ...
    parameters.min_number_per_zone      = 20;
    ...
    parameters.nb_points                = 2000;
    parameters.nb_sliding               = 500 ;
    %% nb of processors
