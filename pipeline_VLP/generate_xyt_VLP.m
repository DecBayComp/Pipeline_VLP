function [xyt, x_target, y_target, t_min, t_max] = generate_xyt_VLP(test,name_folder,filename, pathname,size_pixel, dt_frame_ms,density_criterion,zero_num,name_pipeline )
